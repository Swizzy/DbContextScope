...
namespace Mehdime.Entity.Core.Interfaces
{
    /// <summary>
    ...
    public interface IDbContextScope : IDisposable
    {
        ...
        /// with parsimony).
        /// </summary>
        void RefreshEntitiesInParentScope<TEntity>(IEnumerable<TEntity> entities) where TEntity : class;
		...
		/// with parsimony).
		/// </summary>
        Task RefreshEntitiesInParentScopeAsync<TEntity>(IEnumerable<TEntity> entities) where TEntity : class;
